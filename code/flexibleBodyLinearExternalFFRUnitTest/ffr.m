...
GDot= [ -sin(theta)*cos(psi)-cos(theta)*sin(psi)    cos(psi)   0;
...
% I_ThetaF(1,:)=  qf' * (S_kl_bar(:,:,2,3) - S_kl_bar(:,:,3,2)) ;
% I_ThetaF(2,:)=  qf' * (S_kl_bar(:,:,3,1) - S_kl_bar(:,:,1,3)) ;
% I_ThetaF(3,:)=  qf' * (S_kl_bar(:,:,1,2) - S_kl_bar(:,:,2,1)) ;


I_kl_bar(:,:,2,3) - I_kl_bar(:,:,3,2)
...
GDot, I_ThetaTheta, G, uTheta,  I_ThetaF, uf, 
-2*GDot'*I_ThetaTheta*omega_bar,
- 2*GDot'*I_ThetaF*uf,
- G'*I_ThetaTheta*omega_bar,


Qv(4:6) = -2*GDot'*I_ThetaTheta*omega_bar - 2*GDot'*I_ThetaF*uf - G'*I_ThetaTheta*omega_bar;
for j = 1 : Elements
