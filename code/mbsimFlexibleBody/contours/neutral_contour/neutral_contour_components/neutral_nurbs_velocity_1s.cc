...
//  class FlexibleBodyContinuum<double>;
  ...
  NeutralNurbsVelocity1s::NeutralNurbsVelocity1s(Element* parent_, std::vector<ContourPointData>& transContourPoints_, double nodeOffset_, double uMin_, double uMax_, int degU_, bool openStructure_):
