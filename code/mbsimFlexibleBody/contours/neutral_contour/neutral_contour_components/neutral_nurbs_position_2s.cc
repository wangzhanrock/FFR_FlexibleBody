...
namespace MBSimFlexibleBody {
  ...
  NeutralNurbsPosition2s::NeutralNurbsPosition2s(Element* parent_, fmatvec::GeneralMatrix<ContourPointData>& transContourPoints_, double nodeOffset_, int degU_, int degV_, bool openStructure_):
