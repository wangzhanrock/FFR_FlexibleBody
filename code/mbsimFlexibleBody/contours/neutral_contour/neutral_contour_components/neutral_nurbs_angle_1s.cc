...
namespace MBSimFlexibleBody {
  ...
  NeutralNurbsAngle1s::NeutralNurbsAngle1s(Element* parent_, std::vector<ContourPointData>& rotContourPoints_, double nodeOffset_, double uMin_, double uMax_, int degU_, bool openStructure_):
    NeutralNurbs(parent_, rotContourPoints_, nodeOffset_, uMin_, uMax_, degU_, openStructure_), ANGLE(new Cardan()){
