...
namespace MBSimFlexibleBody {
  ...
  class NeutralNurbsAngle1s : public MBSimFlexibleBody::NeutralNurbs {
    public:
      NeutralNurbsAngle1s(Element* parent_, std::vector<ContourPointData>& rotContourPoints_, double nodeOffset_, double uMin_, double uMax_, int degU_, bool openStructure_);
