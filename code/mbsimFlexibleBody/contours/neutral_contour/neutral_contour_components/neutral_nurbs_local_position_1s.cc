...
namespace MBSimFlexibleBody {
  ...
  NeutralNurbsLocalPosition1s::NeutralNurbsLocalPosition1s(Element* parent_, std::vector<ContourPointData>& transContourPoints_, double nodeOffset_, double uMin_, double uMax_, int degU_, bool openStructure_):
    NeutralNurbs(parent_, transContourPoints_, nodeOffset_, uMin_, uMax_, degU_, openStructure_){
